...
class GQA:
    def __init__(self):
        # load the model
        self.tokenizer = LxmertTokenizer.from_pretrained("unc-nlp/lxmert-base-uncased", cache_dir="cache", force_download = True)
        self.model = LxmertForQuestionAnswering.from_pretrained("unc-nlp/lxmert-base-uncased", cache_dir="cache", force_download = True, num_qa_labels=self.train_tuple.dataset.num_answers)
        # load the data
    ...
    def train(self, train_tuple, eval_tuple):
        ...
        for epoch in range(args.epochs):
            ...
            for i, (ques_id, feats, boxes, sent, target) in iter_wrapper(
                ...
                print(token_type_ids, input_ids, attention_mask)
